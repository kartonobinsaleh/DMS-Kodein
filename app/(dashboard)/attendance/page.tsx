...
export default function AttendancePage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto p-4 md:p-8 pb-32">
      <PageHeader
        title="Check-In / Out"
        subtitle="Kelola pengambilan harian siswa."
      ...
      <div className="relative group">
        ...
        <input
          ...
          className="w-full rounded-container border border-slate-200 bg-white pl-12 pr-4 py-4 text-sm font-bold focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all shadow-sm"
          value={search}
      ...
      <div className="space-y-6">
        {filteredStudents.length === 0 ? (
          <div className="text-center py-20 bg-white rounded-container border border-dashed border-slate-200 flex flex-col items-center">
          ...
          filteredStudents.map((student) => (
            <div key={student.id} className="bg-white rounded-container border border-slate-200 shadow-sm overflow-hidden transition-all hover:shadow-xl hover:border-indigo-100">
